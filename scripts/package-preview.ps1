...
try {
    ...
    $evidence = @(
        ...
        "- Actionable validation status points to Open PCB and Review checklist",
        ...
        "- Open PCB/checklist waits until a preview workspace exists",
        "- Review checklist button for the saved preview workspace",
        "- Review checklist selects BEGINNER-NEXT-STEPS.txt for non-expert review",
