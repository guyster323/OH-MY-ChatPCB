...
21. Click Open evidence to inspect the first-run evidence folder with FIRST-RUN-SUMMARY.txt selected.
...
25. Confirm it reopens the same previous preview folder with FIRST-RUN-SUMMARY.txt selected.
