...
19. Click Open PCB to inspect chatpcb3-esp32s3.kicad_pcb.
20. Confirm the bottom status says either "Opened preview PCB in KiCad PCB Editor." or "Opened preview PCB file. Install KiCad 10 if PCB Editor did not open."
21. If KiCad 10 is installed, confirm the KiCad PCB preview contains a 50mm x 50mm Edge.Cuts outline.
22. Click Open evidence to inspect the first-run evidence folder with FIRST-RUN-SUMMARY.txt selected.
23. Close and reopen the app, then click Open evidence before sending again.
...
26. Confirm it reopens the same previous preview folder with FIRST-RUN-SUMMARY.txt selected.
27. The folder path is:
